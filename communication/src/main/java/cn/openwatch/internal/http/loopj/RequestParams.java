...
package cn.openwatch.internal.http.loopj;
 ...
 * 								// "languages[0]=Java&amp;languages[1]=C"
 *
 * String[] colors = { "blue", "yellow" }; // Ordered collection
 * params.put("colors", colors); // url params:
 * 								// "colors[0]=blue&amp;colors[1]=yellow"
 *
 * File[] files = { new File("pic.jpg"), new File("pic1.jpg") }; // Ordered
 * 																// collection
...
public class RequestParams implements Serializable {
    ...
    private static final long serialVersionUID = -5805209912747022548L;
     ...
     *
     * @param force boolean, should declare content-type multipart/form-data even
    ...
    public RequestParams(final String key, final String value) {
        this(new HashMap<String, String>() {
            private static final long serialVersionUID = -4162240450945637121L;
     ...
     * @throws FileNotFoundException if one of passed files is not found at time of assembling the
    ...
    public boolean has(String key) {
        return urlParams.get(key) != null || streamParams.get(key) != null || fileParams.get(key) != null
    ...
    private List<BasicNameValuePair> getParamsList(String key, Object value) {
        ...
        if (value instanceof Map) {
                ...
                if (nestedKey instanceof String) {
                    ...
                    if (nestedValue != null) {
                        params.addAll(getParamsList(
                                key == null ? (String) nestedKey : String.format(Locale.US, "%s[%s]", key, nestedKey),
                                nestedValue));
                    }
                }
            }
            ...
            for (int nestedValueIndex = 0; nestedValueIndex < listSize; nestedValueIndex++) {
                params.addAll(getParamsList(String.format(Locale.US, "%s[%d]", key, nestedValueIndex),
    ...
    public static class FileWrapper implements Serializable {
        private static final long serialVersionUID = 7427221681827117018L;
